        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <Card className="border-slate-200 shadow-sm bg-white relative overflow-hidden flex flex-col justify-between">
            ...
            <CardContent className="space-y-6">
              ...
              <div className={`rounded-xl p-4 flex items-center justify-between border shadow-inner ${stats.economy > 0 ? 'bg-emerald-50 border-emerald-100' : 'bg-orange-50 border-orange-100'}`}>
                <div className="flex items-center gap-3">
                  <div className={`${stats.economy > 0 ? 'bg-emerald-500' : 'bg-orange-500'} text-white p-2 rounded-lg`}>
                    <TrendingDown className="w-5 h-5" />
                  </div>
                  <span className={`font-semibold ${stats.economy > 0 ? 'text-emerald-900' : 'text-orange-900'}`}>
